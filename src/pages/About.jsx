...
function About() {
    ...
    return (
        ...
        <div className="bg-richblack-700">
            ...
            {/* Section-1 */}
            <section  className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">

                <div className="mx-auto py-20 text-4xl font-semibold lg:w-[68%]">
                    Driving Innovation in Online Education for a
                    <HighlightText text={" Brighter Future"}/>
                </div>

                <p className="mx-auto -mt-[6.8rem] text-center text-base font-medium text-richblack-300 lg:w-[68%]">
                ...
                <div className="sm:h-[110px] lg:h-[230px]"></div>

                <div className="absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5">

                    <img src={BannerImage1} alt="aboutus image1" />
                    <img src={BannerImage2} alt="aboutus image2" />
                    <img src={BannerImage3} alt="aboutus image3" />
                </div>

            </section>

            {/* Section-2 */}
            <section className="bg-richblack-900 w-full border-b border-richblack-700">
                    ...
                    <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
                        ...
                        <div className="my-24 flex lg:w-[50%] flex-col gap-10">
                            ...
                            <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                                ...
                                We believed that education should not be confined to the walls of a classroom or restricted by geographical boundaries. We envisioned a platform that 
                    ...
                    <div className="flex flex-col items-center lg:gap-10 lg:flex-row justify-between">
                        ...
                        <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                            ...
                            <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                                ...
                                the way people learn. Our team of dedicated experts worked tirelessly to develop a robust and intuitive platform that 
            ...
            {/* Review-Slider */}
            <div className="flex flex-col gap-y-20 bg-richblack-900 ">

                <h2 className="text-center text-4xl font-semibold mt-16 mb-6 text-white ">Reviews from other learners</h2>
